...
[oleggorj/spark-on-docker README](https://github.com/oleggorj/spark-on-docker)
...
```
docker run -it --rm oleggorj/spark-scala-template sbt console
```
...
```
FROM oleggorj/spark-scala-template:2.3.1-hadoop2.7
